...
const NAME_COLLECTIONS = [
  ...
  },
  {
    ...
    label: "キッザニア福岡図鑑",
    shortLabel: "キッザニア福岡",
    themeWords: ["キッザニア福岡", "福岡のキッザニア", "キッザニア", "KidZania", "職業体験", "お仕事体験", "仕事体験", "キッゾ"],
    requireThemeForItems: true,
    skillName: "キッザニア図鑑調査",
    skillTags: ["勉強", "キッザニア", "福岡", "図鑑"],
    category: "勉強",
    items: [
      nameEntry("ホテル"),
      nameEntry("グローバルカフェ"),
    ...
    titleThresholds: [
      { count: 1, title: "キッザニア福岡見習い" },
      { count: 3, title: "福岡の職業体験を見守る親" },
      { count: 10, title: "キッザニア福岡職業案内人" },
      { count: 20, title: "キッザニア福岡中級者" },
      { count: 26, title: "キッザニア福岡コンプリート" },
    ],
  },
  {
    id: "kidzania-tokyo",
    label: "キッザニア東京図鑑",
    shortLabel: "キッザニア東京",
    themeWords: ["キッザニア東京", "東京のキッザニア", "キッザニア", "KidZania", "職業体験", "お仕事体験", "仕事体験", "キッゾ"],
    requireThemeForItems: true,
    skillName: "キッザニア図鑑調査",
    skillTags: ["勉強", "キッザニア", "東京", "図鑑"],
    category: "勉強",
    items: [
      nameEntry("飛行機"),
      ...
      nameEntry("病院"),
      nameEntry("商店街/花屋", ["花屋"]),
      nameEntry("商店街/はんこ屋", ["はんこ屋"]),
      nameEntry("商店街/画材屋", ["画材屋"]),
      nameEntry("銀行"),
      nameEntry("宅配会社"),
      nameEntry("警備センター"),
      nameEntry("消防署"),
    ...
    titleThresholds: [
      { count: 1, title: "キッザニア東京見習い" },
      { count: 3, title: "東京の職業体験を見守る親" },
      { count: 10, title: "キッザニア東京職業案内人" },
      { count: 25, title: "キッザニア東京中級者" },
      { count: 40, title: "キッザニア東京マスター" },
      { count: 46, title: "キッザニア東京コンプリート" },
    ],
  },
  {
    id: "dinosaurs",
